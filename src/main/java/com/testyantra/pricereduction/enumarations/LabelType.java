package com.testyantra.pricereduction.enumarations;
...
public enum LabelType {
	ShowWasNow {
		@Override
		public String format(double was, double now, String then1, String then2,String currency) {
	...
	public abstract String format(double was, double now, String then1, String then2,String currency);
}